...
3. Import the Jenkins repository key:
    ```bash
...
7. Enable Jenkins to start on system boot:
    ```bash
...
![Screenshot (11)](https://github.com/harshartz/Jenkins-project/assets/130890384/3618673d-3593-440c-b28a-75d691623685)
